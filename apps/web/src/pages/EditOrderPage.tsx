...
export function EditOrderPage() {
  ...
  // Calculate packing for each product (same logic as NewOrderPage)
      ...
      {results.length > 0 && (
        <div className="card bg-primary-50 border-2 border-primary-200 mb-6">
          ...
          <div className="grid grid-cols-5 gap-4 text-center">
            <div><div className="text-2xl font-bold">{totals.weight.toFixed(1)}</div><div className="text-sm text-gray-600">kg</div></div>
            ...
            <div><div className="text-2xl font-bold text-purple-600">{totals.tubs + totals.boxes}</div><div className="text-sm text-gray-600">Labels</div></div>
          </div>
        </div>
      )}
